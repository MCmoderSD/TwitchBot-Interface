...
public class LogPanel extends JPanel {
    ...
    // Constructor
    public LogPanel(Frame frame, Dimension size, MenuPanel menuPanel) {
    ...
    public void appendText(String type, String channel, String author, String message) {
        if (menuPanel.getChannel().equals(channel) || menuPanel.getChannel().length() < 3) logArea.appendText(type + " <" + channel + "> " + author + ": " + trimMessage(message));
    }
}